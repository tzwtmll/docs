...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><div class="hint-container tip"><p class="hint-container-title">正在开发中。。。</p></div>`,4);function b(_,w){const e=u("RouterLink");return c(),o("div",null,[d,s("ol",null,[k,s("li",null,[n("数据结构能够使程序更加快速，比如"),v,n("发布的"),l(e,{to:"/frontend/react/core.html#diff"},{default:i(()=>[n("fiber 数据结构")]),_:1}),m,n(" :::")])]),h])}const x=p(r,[["render",b],["__file","dataStructure.html.vue"]]);export{x as default};
