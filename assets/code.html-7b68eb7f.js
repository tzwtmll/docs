import{_ as n,X as s,Y as a,a0 as p}from"./framework-decf3de5.js";const t={},e=p(`<h1 id="react-完整源码" tabindex="-1"><a class="header-anchor" href="#react-完整源码" aria-hidden="true">#</a> React 完整源码</h1><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token keyword">let</span> nextUnitOfWork <span class="token operator">=</span> <span class="token keyword">null</span>
